...
namespace SolidarityConnection.Donations.Api.Extensions
{
    ...
    {
        public static IServiceCollection OpenTelemetry(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddOpenTelemetry()
                ...
                {
                    builder
                        .AddSource("SolidarityConnection.Donations.Application")
        ...
        private static void ConfigureOtlpExporter(OtlpExporterOptions options, IConfiguration configuration)
        {
            ...
            var protocol = configuration["NewRelic:Protocol"] ?? "http/protobuf";
